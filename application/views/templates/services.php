...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/styles/services.css') ?> ">
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/styles/services_responsive.css') ?> ">
</head>
...
<!-- Home -->
	...
	<div class="home" >
		<div id="idservices" class="parallax_background parallax-window" data-parallax="scroll" data-image-src="<?php echo base_url('assets/images/services.jpg') ?> " data-speed="0.8"></div>
		...
		<div class="home_container">
			<div class="container">
				<div class="row">
					<div class="col">
						<div id="idtitreservices" class="home_content">
	...
	<div id="idcontenuservices" class="services">
		<div class="container">
			<div class="row">
			...
			<div class="row icon_boxes_row">
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="<?php echo base_url('assets/images/icon_1.svg') ?>" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="<?php echo base_url('assets/images/icon_2.svg') ?>" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="<?php echo base_url('assets/images/icon_3.svg') ?>" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="<?php echo base_url('assets/images/icon_4.svg') ?>" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="<?php echo base_url('assets/images/icon_5.svg') ?>" alt=""></div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="<?php echo base_url('assets/images/icon_6.svg') ?>" alt=""></div>
					...
					<div class="tab_panels">
						...
						<div class="tab_panel active">
							<div class="tab_panel_content">
								<div class="row">
									<div class="col-lg-5">
										<div class="tab_image"><img src="<?php echo base_url('assets/images/tabs.jpg') ?> " alt=""></div>
									</div>
									<div class="col-lg-7">
										<div class="tab_list">
											<ul>
